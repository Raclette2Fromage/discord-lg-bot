...
function buildLGCommand() {
  const lg = new SlashCommandBuilder()
    ...
    .addSubcommand(s =>
      s.setName("kick")
        .setDescription("Éjecter un joueur avant le lancement")
        .addUserOption(o =>
          o.setName("user").setDescription("Joueur à éjecter").setRequired(true)
        )
    )
    ...
    .addSubcommand(s => {
      ...
      s.addIntegerOption(o =>
        o.setName("joueurs").setDescription("Nombre total de joueurs").setRequired(true)
      );
      s.addBooleanOption(o =>
        o.setName("compo_visible").setDescription("Annoncer la composition")
      );
      s.addStringOption(o =>
        o.setName("reveal").setDescription("Révélation des rôles").addChoices(
      ...
      s.addStringOption(o =>
        o.setName("voyante").setDescription("Type de Voyante").addChoices(
          { name: "Classique", value: "classic" },
          { name: "Bavarde", value: "bavarde" }, // ✅ aligné avec handleConfig
          { name: "Aucune", value: "none" }
        )
      );
      s.addBooleanOption(o =>
        o.setName("cupidon_self").setDescription("Cupidon peut être dans le couple")
      );
      s.addBooleanOption(o =>
        o.setName("cupidon_random").setDescription("Couple aléatoire")
      );
      s.addStringOption(o =>
        o.setName("roles").setDescription("Ex: loup=2 sorciere=1 voyante=1 …")
      );
      return s;
    })
    ...
    .addSubcommand(s => s.setName("compo").setDescription("Afficher la composition (si visible)"))
    ...
    .addSubcommand(s => s.setName("roles").setDescription("Liste des rôles et pouvoirs")); // ✅ ajouté
